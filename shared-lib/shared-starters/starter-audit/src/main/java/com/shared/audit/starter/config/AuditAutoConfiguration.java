...
import com.shared.audit.starter.core.enrich.MdcHeaderEnricher;
...
public class AuditAutoConfiguration {
  ...
  @Bean @ConditionalOnMissingBean public MdcHeaderEnricher mdcHeaderEnricher() { return new MdcHeaderEnricher(); }
