...
public class TenantIntegrationKeyController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Integration key created successfully",
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Integration key updated successfully"),
            @ApiResponse(responseCode = "400", description = "Invalid input data"),
            @ApiResponse(responseCode = "403", description = "Access denied"),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Integration key retrieved successfully"),
            @ApiResponse(responseCode = "403", description = "Access denied"),
            @ApiResponse(responseCode = "404", description = "Integration key not found")
    })
    @GetMapping("/{id}")
    ...
    @TenantAuthorized
    @Operation(summary = "List integration keys by tenant",
            description = "Retrieves a paginated list of integration keys for a tenant")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Integration keys retrieved successfully"),
            @ApiResponse(responseCode = "403", description = "Access denied"),
    ...
    @TenantAuthorized
    @Operation(summary = "Revoke integration key",
            description = "Soft deletes and revokes the integration key with the specified ID")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "Integration key revoked successfully"),
            @ApiResponse(responseCode = "403", description = "Access denied"),
            @ApiResponse(responseCode = "404", description = "Integration key not found")
    })
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> revoke(@PathVariable("id") @Min(1) final Long tikId) {
