package com.ejada.tenant.subscription;

import com.ejada.tenant.subscription.service.SubscriptionService;
...
class SubscriptionServiceIT {
    ...
    void enforcesSingleActiveSubscriptionPerTenant() {
        ...
        repository.saveAndFlush(new com.ejada.tenant.subscription.domain.TenantSubscription(UUID.randomUUID(), tenantId, com.ejada.tenant.subscription.domain.SubscriptionStatus.TRIAL, true));
        assertThatThrownBy(() -> {
            repository.saveAndFlush(new com.ejada.tenant.subscription.domain.TenantSubscription(UUID.randomUUID(), tenantId, com.ejada.tenant.subscription.domain.SubscriptionStatus.ACTIVE, true));
