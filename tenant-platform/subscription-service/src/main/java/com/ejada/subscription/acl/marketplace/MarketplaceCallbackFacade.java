package com.ejada.subscription.acl.marketplace;

import com.ejada.common.dto.ServiceResult;
import com.ejada.common.marketplace.dto.ProductPropertyDto;
...
import com.ejada.common.marketplace.dto.SubscriptionAdditionalServiceDto;
...
/**
 * Anti-corruption layer for marketplace callbacks:
...
@Slf4j
public class MarketplaceCallbackFacade {
    ...
    @Transactional
    public ServiceResult<ReceiveSubscriptionNotificationRs> handleNotification(
            final UUID rqUid,
            final String token,
    ...
    @Transactional
    public ServiceResult<Void> handleUpdate(
            final UUID rqUid,
            final String token,
    ...
    private InboundNotificationAudit recordInboundAudit(final UUID rqUid,
        ...
        audit.setTokenHash(TokenHashUtils.sha256(token));
    ...
    private void recordIdempotentRequest(final UUID rqUid, final String endpoint, final Object payload) {
        ...
        runInNewTransaction(() -> {
            ...
            request.setRequestHash(TokenHashUtils.sha256(writeJson(payload)));
            try {
