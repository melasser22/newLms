...
public class ConsumptionServiceImpl implements ConsumptionService {
    ...
    @Override
    @Transactional
    public ServiceResult<TrackProductConsumptionRs> trackProductConsumption(UUID rqUid, String token, TrackProductConsumptionRq rq) {
        try {
