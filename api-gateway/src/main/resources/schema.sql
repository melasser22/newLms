...
VALUES
    ...
    (
        ...
        '[{"name":"StripPrefix","args":{"parts":"1"}},{"name":"PrefixPath","args":{"prefix":"/sec/api/v1"}},{"name":"SetRequestHeader","args":{"name":"Authorization","value":"$request.header.Authorization"}},{"name":"AddRequestHeader","args":{"name":"X-Route-Source","value":"database"}}]'::jsonb,
        '{"methods":["GET","POST","PUT","PATCH","DELETE"],"stripPrefix":1,"prefixPath":"/sec/api/v1","requestHeaders":{"X-Route-Seed":"true"},"setRequestHeaders":{"Authorization":"$request.header.Authorization"},"statelessAuth":true}'::jsonb,
        TRUE,
        1,
        NOW(),
        NOW()
