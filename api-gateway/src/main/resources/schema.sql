...
VALUES
    ...
    (
        ...
        '[{"name":"StripPrefix","args":{"parts":"1"}},{"name":"PrefixPath","args":{"prefix":"/api/v1"}},{"name":"AddRequestHeader","args":{"name":"X-Route-Source","value":"database"}}]'::jsonb,
        '{"methods":["GET","POST","PUT","PATCH","DELETE"],"stripPrefix":1,"prefixPath":"/api/v1","requestHeaders":{"X-Route-Seed":"true"}}'::jsonb,
        TRUE,
        1,
        NOW(),
        NOW()
